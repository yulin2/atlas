...
public class AtlasProcessingWebApplicationContext extends AnnotationConfigWebApplicationContext {
    ...
    private void configure(Builder<Class<?>> builder) {
        ...
        builder.add(AtlasLoggingModule.class, MongoContentPersistenceModule.class, CassandraContentPersistenceModule.class, AtlasFetchModule.class, RemoteSiteModule.class);
