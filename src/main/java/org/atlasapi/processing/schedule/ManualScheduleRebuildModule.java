...
public class ManualScheduleRebuildModule {
	...
	public void installScheduleRebuilder() {
	    ScheduledTask everythingRepopulator =
	    	new ScheduleRepopulator(lister, channelResolver, scheduleStore, ImmutableList.<Publisher>of())
	    ...
	    ScheduledTask bbcRepopulator = 
	    	new ScheduleRepopulator(lister, channelResolver, scheduleStore, ImmutableList.<Publisher>of(Publisher.BBC))
        ...
        ScheduledTask bbcFullRepopulator = 
                new ScheduleRepopulator(lister, channelResolver, scheduleStore, ImmutableList.<Publisher>of(Publisher.BBC), Duration.standardDays(100*365))
        ...
        ScheduledTask c4Repopulator = 
        	new ScheduleRepopulator(lister, channelResolver, scheduleStore, ImmutableList.<Publisher>of(Publisher.C4))
        ...
        ScheduledTask reduxRepopulator = 
                new ScheduleRepopulator(lister, channelResolver, scheduleStore, ImmutableList.<Publisher>of(Publisher.BBC_REDUX), Duration.standardDays(30*365))
