...
public class ContentGroupModelSimplifier extends DescribedModelSimplifier<org.atlasapi.media.content.ContentGroup, org.atlasapi.media.entity.simple.ContentGroup> {

    @Override
    public org.atlasapi.media.entity.simple.ContentGroup simplify(org.atlasapi.media.content.ContentGroup model, Set<Annotation> annotations, ApplicationConfiguration config) {
