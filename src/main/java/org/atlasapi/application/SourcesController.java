...
public class SourcesController {
     ...
     * Updates permission for a source. Post with app id and permission (read/write) required
     ...
     * Removes a permission (read/write) from an app on a source. Post with app id and permission needed.
     */
     ...
     * Changes state of app for source, e.g. "available", "requested". 
     * Params:  "state": "available"
     */
    public void changeSourceStateForApplication(HttpServletRequest request, HttpServletResponse response) {
