...
public class IndexBackedTopicQueryExecutor implements TopicQueryExecutor {
    ...
    @Override
    public TopicQueryResult execute(TopicQuery query) throws TopicQueryExecutionException {
