...
public class BbcIonScheduleController {
    ...
    public BbcIonScheduleController(RemoteSiteClient<IonSchedule> scheduleClient, BbcIonBroadcastHandler handler, ChannelResolver channelResolver, AdapterLog log) {
    ...
    public void updateDay(@PathVariable String service, @PathVariable String date, HttpServletResponse response) throws IOException {
        ...
        executor.submit(new BbcIonScheduleUpdateTask(String.format(SCHEDULE_DEFAULT_FORMAT, service, localDate), scheduleClient, handler, channelResolver, log));
