...
import org.atlasapi.remotesite.rovi.model.AudioLevel;
import org.atlasapi.remotesite.rovi.model.CaptionType;
import org.atlasapi.remotesite.rovi.model.ScheduleLine;
import org.atlasapi.remotesite.rovi.model.SheduleShowingType;
...
public class ScheduleLineParser implements RoviLineParser<ScheduleLine>{
    ...
    public ScheduleLine apply(String line) {
        ...
        SheduleShowingType showingType = parseAsShowingType(lineIt.next());
    ...
    private SheduleShowingType parseAsShowingType(String s) {
        // TODO
        return null;
    }
