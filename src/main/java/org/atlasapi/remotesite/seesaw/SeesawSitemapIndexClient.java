...
public class SeesawSitemapIndexClient implements RemoteSiteClient<List<String>>{
    ...
    public List<String> get(String url) throws Exception {
        ...
        Elements elements = doc.getRootElement().getChildElements("sitemap", NS);
        for (int i=0; i<elements.size(); i++) {
            ...
            if (element != null) {
                ...
                if (location != null && location.getValue() != null) {
                    sitemaps.add(location.getValue());
                }
            }
        }
