...
@XmlRootElement(name = "listings_date")
public class ListingsDate {

    @XmlAttribute(required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String date;
    @XmlElement(name = "channel_data", required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the channelData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChannelData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
