...
//        channelMap.put(724, Channel.BBC_TWO_LONDON);
        ...
        channelMap.put(45, Channel.ITV1_WALES);
        channelMap.put(46, Channel.ITV1_WEST);
        channelMap.put(47, Channel.ITV1_CARLTON-CENTRAL);
        channelMap.put(48, Channel.ITV1_CARLTON-WESTCOUNTRY);
        channelMap.put(698, Channel.ITV1_BORDER_NORTH);
        channelMap.put(1296, Channel.ITV1_THAMES_VALLEY_NORTH);
        channelMap.put(1297, Channel.ITV1_THAMES_VALLEY_SOUTH);
        channelMap.put(53, Channel.Channel_4);
        channelMap.put(1379, Channel.Channel_4_+1);
        channelMap.put(1404, Channel.Channel_4_HD);
        channelMap.put(54, Channel.Channel_5);
        ...
        channelMap.put(451, Channel.ITV2);
        channelMap.put(1291, Channel.ITV2_+1);
        channelMap.put(1602, Channel.ITV2_HD);
        channelMap.put(605, Channel.E4);
        channelMap.put(1055, Channel.E4_+1);
        channelMap.put(1534, Channel.E4_HD);
        channelMap.put(733, Channel.CBBC);
        channelMap.put(734, Channel.CBEEBIES);
        channelMap.put(742, Channel.BBC4);
        channelMap.put(935, Channel.BBC3);
        channelMap.put(1065, Channel.ITV3);
        channelMap.put(1612, Channel.ITV3_HD);
        channelMap.put(1292, Channel.ITV3_+1);
        channelMap.put(1167, Channel.MORE4);
        channelMap.put(1168, Channel.MORE4_+1);
        channelMap.put(1174, Channel.ITV4);
        channelMap.put(1613, Channel.ITV4_HD);
        channelMap.put(1457, Channel.ITV4_+1);
        channelMap.put(1204, Channel.CITV);
        channelMap.put(1228, Channel.BBC_HD);
        channelMap.put(1289, Channel.FIVER);
        channelMap.put(1580, Channel.Channel_5_HD);
        channelMap.put(1485, Channel.FIVER_+1);
        channelMap.put(1290, Channel.FIVE_USA);
        channelMap.put(1484, Channel.FIVE_USA_+1);
        channelMap.put(1442, Channel.BBC_ALBA);
        channelMap.put(1560, Channel.ITV1_HD);
        channelMap.put(55, Channel.THE_ADULT_Channel);
        channelMap.put(56, Channel.BBC_PARLIAMENT);
        channelMap.put(59, Channel.MTV_HITS);
        channelMap.put(63, Channel.MTV_BASE);
        channelMap.put(64, Channel.MTV);
        channelMap.put(1408, Channel.MTV_+1);
        channelMap.put(66, Channel.TRAVELChannel);
        channelMap.put(943, Channel.TRAVELChannel_+1);
        ...
        channelMap.put(1071, Channel.CHALLENGE_+1);
        channelMap.put(89, Channel.HOME);
        channelMap.put(756, Channel.HOME_+1);
        ...
        channelMap.put(700, Channel.ANIMAL_PLANET_+1);
        ...
        channelMap.put(987, Channel.LIVING_+1);
        channelMap.put(1495, Channel.LIVING_HD);
        channelMap.put(166, Channel.BRAVO);
        channelMap.put(986, Channel.BRAVO_+1);
        ...
        channelMap.put(1543, Channel.DISCOVERY_SCIENCE_+1);
        channelMap.put(130, Channel.DISCOVERY_TRAVEL_&AMP;_LIVING);
        channelMap.put(1471, Channel.DISCOVERY_TRAVEL_&AMP;_LIVING_+1);
        channelMap.put(171, Channel.HISTORY);
        channelMap.put(702, Channel.HISTORY_+1);
        channelMap.put(177, Channel.NATIONAL_GEOGRAPHIC);
        channelMap.put(710, Channel.NATIONAL_GEOGRAPHIC_+1);
        channelMap.put(134, Channel.GOLD);
        channelMap.put(899, Channel.GOLD_+1);
        channelMap.put(136, Channel.THE_DISNEY_Channel);
        channelMap.put(707, Channel.THE_DISNEY_Channel_+1);
        channelMap.put(138, Channel.BBC_WORLD_NEWS);
        ...
        channelMap.put(1205, Channel.BOOMERANG_+1);
        ...
        channelMap.put(708, Channel.FILM4_+1);
        channelMap.put(222, Channel.SKY1);
        channelMap.put(227, Channel.DISCOVERY_HOME_&AMP;_HEALTH);
        channelMap.put(1148, Channel.DISCOVERY_HOME_&AMP;_HEALTH_+1);
        ...
        channelMap.put(988, Channel.GOOD_FOOD_+1);
        ...
        channelMap.put(1068, Channel.YESTERDAY_+1);
        ...
        channelMap.put(1470, Channel.LIVINGIT_+1);
        ...
        channelMap.put(1539, Channel.COMEDY_CENTRAL_EXTRA_+1);
        ...
        channelMap.put(1135, Channel.DISCOVERY_REAL_TIME_+1);
        ...
        channelMap.put(1207, Channel.DISNEY_CINEMAGIC_+1);
        ...
        channelMap.put(1308, Channel.CRIME_&AMP;_INVESTIGATION);
        channelMap.put(1491, Channel.CRIME_&AMP;_INVESTIGATION_+1);
        channelMap.put(1318, Channel.SKY_MOVIES_CHRISTMAS_Channel);
        channelMap.put(1536, Channel.SKY_MOVIES_CHRISTMAS_Channel_HD);
        channelMap.put(1319, Channel.SKY_MOVIES_CRIME_&AMP;_THRILLER);
        channelMap.put(1537, Channel.SKY_MOVIES_CRIME_&AMP;_THRILLER_HD);
        channelMap.put(1320, Channel.SKY_MOVIES_PREMIERE);
        channelMap.put(1321, Channel.SKY_MOVIES_PREMIERE_+1);
        ...
        channelMap.put(1328, Channel.SKY_MOVIES_ACTION_&AMP;_ADVENTURE);
        channelMap.put(1444, Channel.SKY_MOVIES_ACTION_&AMP;_ADVENTURE_HD);
        channelMap.put(1323, Channel.SKY_MOVIES_FAMILY);
        channelMap.put(1448, Channel.SKY_MOVIES_FAMILY_HD);
        channelMap.put(1324, Channel.SKY_MOVIES_DRAMA_&AMP;_ROMANCE);
        channelMap.put(1445, Channel.SKY_MOVIES_DRAMA_&AMP;_ROMANCE_HD);
        ...
        channelMap.put(1525, Channel.DIVA_+1);
        channelMap.put(1387, Channel.Channel_ONE);
        channelMap.put(1529, Channel.Channel_ONE_+1);
        ...
        channelMap.put(1538, Channel.DMAX_+1);
        channelMap.put(1614, Channel.DMAX_+2);
        channelMap.put(1412, Channel.HORSE_&AMP;_COUNTRY);
        ...
        channelMap.put(1541, Channel.MOVIES4MEN_+1);
        channelMap.put(1432, Channel.TRUE_MOVIES_2);
        channelMap.put(1433, Channel.MOVIES4MEN2);
        channelMap.put(1542, Channel.MOVIES4MEN2_+1);
        ...
        channelMap.put(1451, Channel.WATCH_+1);
        ...
        channelMap.put(1480, Channel.CRIME_&AMP;_INVESTIGATION_HD);
        channelMap.put(1482, Channel.NAT_GEO_WILD_HD);
        channelMap.put(1483, Channel.QUEST);
        channelMap.put(1521, Channel.DISCOVERY_QUEST_+1);
        ...
        channelMap.put(1498, Channel.DISNEY_XD_+1);
        ...
        channelMap.put(1524, Channel.FOOD_NETWORK_+1);
