...
public class PaEmptyScheduleProcessor implements PaProgDataProcessor {
    ...
    private boolean emptySlot(ProgData progData, Channel channel, DateTimeZone zone) {
        ...
        Schedule schedule = scheduleResolver.schedule(transmissionTime, transmissionEndTime, ImmutableSet.of(channel), ImmutableSet.of(Publisher.PA), Optional.<ApplicationSources>absent());
