...
public class BtEventConfiguration {
    ...
    private static final Map<String, String> VENUE_LOOKUP = ImmutableMap.<String, String>builder()
            ...
            .build();
    private static final Map<BtSportType, Iterable<String>> EVENT_GROUPS_LOOKUP = ImmutableMap.<BtSportType, Iterable<String>>builder()
            .put(BtSportType.UFC, ImmutableList.of("http://dbpedia.org/resources/UFC"))
            .put(BtSportType.MOTO_GP, ImmutableList.of("http://dbpedia.org/resources/Moto_gp", "http://dbpedia.org/resources/Motorsport"))
            .build();
    
    private BtEventConfiguration() { }
    
    public static String createEventUri(String id) {
        return EVENT_URI_BASE + id;
    }
    
    public static Optional<String> fetchLocationUrl(String location) {
        return Optional.fromNullable(VENUE_LOOKUP.get(location));
    }
    
    public static Optional<Iterable<String>> fetchEventGroups(BtSportType sport) {
