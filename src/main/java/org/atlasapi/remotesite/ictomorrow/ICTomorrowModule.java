...
public class ICTomorrowModule {
    ...
    @Bean ICTomorrowPlaylistUpdater ictomorrowPlaylistUpdater() {
        return new ICTomorrowPlaylistUpdater(new ICTomorrowApiHelper(new UsernameAndPassword(ictUsername, ictPassword)), contentStore);
    }
}
