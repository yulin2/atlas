...
public class AtlasModule {
    ...
    @Bean
    public ContentPersistenceModule mongoContentPersistenceModule() {
        return new MongoContentPersistenceModule(databasedMongo());
    }

    @Bean
    public ContentPersistenceModule cassandraContentPersistenceModule() {
