...
public class DelegatingModelTransformer implements ModelTransformer<Description, Content> {
    ...
    public DelegatingModelTransformer(ModelTransformer<org.atlasapi.media.entity.simple.Playlist, Brand> brandTransformer, ModelTransformer<Item,org.atlasapi.media.entity.Item> itemTransformer) {
