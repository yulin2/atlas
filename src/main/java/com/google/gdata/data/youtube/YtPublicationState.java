...
/**
 * This class is here ONLY while issue http://code.google.com/p/gdata-java-client/issues/detail?id=126
 * exists. We work around the problem by adding an extra State RESTRICTED in the State enum below.
 * 
 * Once a new version of the GData client library is released, we can use that instead.
 * 
 * -- Robert Chatley robert@metabroadcast.com  22/06/2009
 */
