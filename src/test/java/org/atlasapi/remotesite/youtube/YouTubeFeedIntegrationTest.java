...
public class YouTubeFeedIntegrationTest extends TestCase {
    ...
    public void testShouldRetrievePlaylist() throws Exception {
        ...
        Playlist playlist = feedAdapter.fetch(uri);
        assertNotNull(playlist);
        assertEquals(new YouTubeFeedCanonicaliser().canonicalise(uri), playlist.getCanonicalUri());
        assertEquals(YouTubeFeedCanonicaliser.curieFor(uri), playlist.getCurie());
