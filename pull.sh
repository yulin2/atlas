...
cd ../atlas-persistence/ && git pull origin master && mvn clean install && mvn eclipse:eclipse
cd ../atlas-client/ && git pull origin master && mvn clean install && mvn eclipse:eclipse
cd ../atlas/ && git pull origin master && mvn clean install && mvn eclipse:eclipse
